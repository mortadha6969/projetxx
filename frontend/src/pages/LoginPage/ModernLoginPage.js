            ...
            <div className="md:w-5/12 bg-gradient-to-br from-primary-500 to-primary-600 p-8 text-white">
              ...
              >
                ...
                <p className="text-primary-100 text-center mb-8">
                  Join the thousands of creators and supporters who use CrowdFunding every day to bring amazing projects to life.
                </p>

                <div className="space-y-6">
                  <div className="bg-white/10 p-4 rounded-lg">
                    <p className="italic text-sm mb-3">
                      "CrowdFunding made it so easy to raise money for my art installation. The platform is intuitive and the community is incredibly supportive."
                    </p>
                  ...
                  <div className="bg-white/10 p-4 rounded-lg">
                    <p className="italic text-sm mb-3">
                      "As a backer, I love how easy it is to discover and support new projects on CrowdFunding. The platform keeps me updated on all my contributions."
                    </p>
                    <div className="flex items-center">
